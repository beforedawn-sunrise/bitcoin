export default {
	...
	"openNum": "请输入开仓数量",
		...
		"email": "商务邮箱",
		"email_pre": "客服：",
		"email_info": "官方邮箱：huobi@Bceoin.vip",
		"feedback": "问题反馈",
		"address": "新加坡© 2013-2020 Bceoin",
		"about2": "公司简介",
		"service": "服务",
		"coin": "数字资产介绍",
		"apply_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=195",
		"feedback_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=200",
		"about2_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=206",
		"coin_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=211",
		"yinsi_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=216",
		"feilv_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=221",
		"legal_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=226"
},
	"home": {
	"with": "对",
		"myMarkets": "自选",
		...
		"img2": "2_zh.png",
		"img3": "3_zh.png",
		"d1": "Bceoin 全球站，近24小时成交量<b>{number}</b>美元",
	...
	"tip": "请注意用户认证信息一经验证不能修改，请务必如实填写准确信息认真填些个人信息",
		...
		"back": "证件照背面",
		"hand": "上传手持证件照",
		"tip2": "请提供一张您手持证件照的照片，在同张照片中也要包含有“Bceoin”、日期和您的签名的注释。请确保您的脸部清晰可见，且所有证件详细信息都清楚可读",
		"face": "面部清晰可见无遮挡",
		"clearly": "照片清晰可见",
		"notes": "带有[Bceoin]的文字注释",
		...
		"tip4": " 请提供一张您本人的Bceoin账号的资产明细截图或者照片，图片中包含您的账户名、uid、持仓详情、当前时间。所有信息清晰可读。",
		"screenshot": "上传资产截图信息",
		"nowLever": "当前认证等级",
		"authCard": "身份证",
		"hu": "护照",
	...
	"hot": "热门项目",
		...
		"nodata": "暂无数据",
		"search": "搜索",
		"tips": "*当前页展示内容为项目方自行填写，Bceoin不对此内容真实性负责",
		"time": "发行时间",
		"total": "发行总量",
		"circulation": "代币流通量",
		"price": "发行价",
