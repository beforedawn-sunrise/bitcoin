export default {
    ...
    "hxex": "Bceoinにてご绍介します",
        ...
        "wechat": "WeChat",
        "weibo": "微博",
        "email_info": "メールボックス：huobi@Bceoin.vip",
        "email_pre": "カスタマーサービス：",
        "address": "シンガポール© 2013-2020 Bceoin",
        "email": "ビジネスメールアドレス",
        "feedback": "問題フィードバック",
        "about2": "会社の概要",
        "coin": "デジタル資産の紹介",
        "service": "サービス",
        "apply_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=197",
        "feedback_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=202",
        "about2_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=208",
        "coin_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=213",
        "yinsi_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=218",
        "feilv_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=223",
        "legal_url": "https://Bceoin.vip/dist/#/components/noticeDetail?id=228"
},
    "home": {
    "with": "はい、",
        "myMarkets": "交易所",
        ...
        "atrade": "Bceoinグローバルステーションのアカウントを登録して、取引の旅を開始します。",
        "Gcoin": "Bceoin",
        ...
        "img2": "2_jp.png",
        "img3": "3_jp.png",
        "d1": "Bceoin Global，24時間の出来高<b>{number}</b>ドル",
    ...
    "tip": "ユーザ認証情報は検証されても、修正できませんので、必ず正確な情報を正直に記入してください",
        ...
        "tip2": "証明書を持って撮った写真を提供してください。同じ写真にも「Bceoin」と日付とサインのコメントが含まれています。顔がよく見えるようにしてください。証明書の詳細は全部分かります",
        "face": "顔がくっきりと見える",
        "clearly": "写真が鮮明に見える",
        "notes": "[Bceoin]の文字コメントが付いています",
        ...
        "tip4": " ご本人のBceoinアカウントの資産明細のスクリーンショットまたは写真を提供してください。画像にはお客様の口座名、uid、在庫保持の詳細、現在の時間が含まれています。すべての情報をクリアして読むことができます。",
    ...
    "hot": "よく知られている",
        ...
        "nodata": "データがありません",
        "search": "索",
        "tips": "*現在のページの展示内容はプロジェクト側自身で記入して、Bceoinはこの内容の真実性に責任を負わない",
        "time": "発行時間",
        "total": "総発行量",
        "circulation": "トークンフロー",
        "price": "発行価格",
